...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($file_type, $file_path, $sitemap_data)
        {
                        return \Sitemap\SitemapStaticFactory::create($file_type, $file_path, $sitemap_data);
        }
...
namespace  { 
            ...
            class Sitemap extends \Sitemap\SitemapFacade {}
